...
class _ProInventoryManagerState extends State<ProInventoryManager> {
  ...
  Widget build(BuildContext context) {
    ...
    if (inventoryProvider.error != null && inventoryProvider.inventoryItems.isEmpty) {
      return _buildErrorState(inventoryProvider.error!);
    }
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(inventoryProvider.error!),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              isSearching ? 'No products found' : 'No products in inventory',
              style: GoogleFonts.poppins(
                fontSize: 20,
                fontWeight: FontWeight.w500,
                color: Colors.grey[600],
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _infoChip('${item.weightPerBag.toStringAsFixed(1)} ${item.unit}/bag',
                        icon: Icons.scale, ),
                    const SizedBox(width: 8),
                    _infoChip('₹${item.pricePerBag.toStringAsFixed(2)}/bag',
                        icon: Icons.currency_rupee),
                  ],
                ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          child: ProductDetailsSheet(item: item, showMarathi: _showMarathi),
        );
      },
    );
  }
...
// Product Details Bottom Sheet - IMPROVED UI
class ProductDetailsSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final marathiName = item.nameHindi ?? item.name;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: GlobalColors.primaryBlue.withOpacity(0.1)),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            GridView.count(
              ...
              children: [
                _metricCard(
                  title: 'Total Bags',
                  value: item.bags.toStringAsFixed(0),
                  icon: Icons.inventory,
                  color: Colors.blue,
                  unit: 'Bags',
                ),
                _metricCard(
                  title: 'Total Tons',
                  value: item.tons.toStringAsFixed(2),
                  icon: Icons.scale,
                  color: Colors.green,
                  unit: 'Tons',
                ),
                _metricCard(
                  title: 'Total Value',
                  value: '₹${item.totalValue.toStringAsFixed(0)}',
                  icon: Icons.currency_rupee,
                  color: Colors.orange,
                  unit: '',
                ),
                _metricCard(
                  title: 'Min Stock',
                  value: item.minBagsStock.toStringAsFixed(0),
                  icon: Icons.warning,
                  color: Colors.red,
                  unit: 'Bags',
                ),
              ...
              child: Column(
                children: [
                  _detailRow(
                    ...
                    value: '${item.weightPerBag.toStringAsFixed(1)} ${item.unit}',
                    icon: Icons.scale,
                  ...
                  _detailRow(
                    label: 'Price per Bag',
                    value: '₹${item.pricePerBag.toStringAsFixed(2)}',
                    icon: Icons.currency_rupee,
                  ...
                  _detailRow(
                    label: 'Price per Ton',
                    value: '₹${item.pricePerTon.toStringAsFixed(0)}',
                    icon: Icons.currency_rupee,
                  ...
                  if (item.description != null && item.description!.isNotEmpty) ...[
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Icon(Icons.description, size: 20, color: Colors.purple),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
            ...
            _sectionHeader('Stock Status'),
            const SizedBox(height: 12),
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: item.isLowStock ? Colors.orange.withOpacity(0.05) : Colors.green.withOpacity(0.05),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: item.isLowStock ? Colors.orange.withOpacity(0.2) : Colors.green.withOpacity(0.2),
                ),
              ),
              child: Row(
                children: [
                  Container(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                      color: item.isLowStock ? Colors.orange.withOpacity(0.1) : Colors.green.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(20),
                    ),
                    child: Icon(
                      item.isLowStock ? Icons.warning : Icons.check_circle,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          item.isLowStock
                              ? 'Current stock (${item.bags.toStringAsFixed(0)} bags) is below minimum required (${item.minBagsStock.toStringAsFixed(0)} bags)'
                              : 'Current stock (${item.bags.toStringAsFixed(0)} bags) meets minimum requirement (${item.minBagsStock.toStringAsFixed(0)} bags)',
                          style: GoogleFonts.poppins(
                            fontSize: 13,
                            color: Colors.grey[600],
                          ),
...
//   Widget _summaryCard({required String title, required String value, required IconData icon, required Color color, required int size}) {
//     return Container(
...
//                   _detailRow(
//                     label: 'Weight per Bag',
//                     value: '${item.weightPerBag} ${item.unit}',
//                     icon: Icons.scale,
//                     iconColor: Colors.blue,
//                   ),
//                   const SizedBox(height: 12),
