...
class _ProductionDashboardState extends State<ProductionDashboard> with WidgetsBindingObserver {
  int _currentIndex = 0;
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) {
          return AlertDialog(
            ...
            title: Row(
              children: [
                Icon(Icons.notifications_active, color: GlobalColors.primaryBlue),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Switch(
                        value: ordersProvider.autoSendWhatsApp,
                        onChanged: (value) {
                          ordersProvider.setAutoSendWhatsApp(value);
                          setState(() {});
                        },
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Switch(
                        value: ordersProvider.autoSendEmail,
                        onChanged: (value) {
                          ordersProvider.setAutoSendEmail(value);
                          setState(() {});
                        },
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'When enabled, customers will automatically receive WhatsApp/Email notifications when you update their order status.',
                          style: GoogleFonts.poppins(
                            fontSize: 12,
  ...
  Widget build(BuildContext context) {
    _setupNotificationCallbacks(context);
    ...
    switch (routeName) {
      ...
      case '/orders':
        return ProductionOrdersPage(
          productionProfile: widget.userData, 
          onDataChanged: () {},
        );
      case '/profile':
...
class _DashboardContentState extends State<DashboardContent> {
  ...
  Future<void> _fetchTotalInventoryBags() async {
    ...
    try {
      ...
      debugPrint('📊 Total bags: $totalBags');
    } catch (e) {
  ...
  Future<void> _calculateProfitMetrics() async {
    ...
    try {
      ...
      final monthEndStr = "${monthEnd.year}-${monthEnd.month.toString().padLeft(2, '0')}-${monthEnd.day.toString().padLeft(2, '0')}";
      
      print('📊 Calculating profit for period: $monthStartStr to $monthEndStr');
      
      double totalRevenue = 0.0;
      double totalRawMaterialCost = 0.0;
      Map<String, double> rawMaterialCosts = {};

      // Fetch completed orders for current month
      ...
      // Fetch raw material usage for current month
      ...
      print('📦 Total Raw Material Cost: ₹$totalRawMaterialCost');
      print('📦 Raw Material Details: $rawMaterialCosts');
  ...
  Future<void> _fetchProductionMetrics() async {
    if (!_isMounted) return;
    // Add production metrics logic here
  }
...
// import 'package:mega_pro/providers/pro_orders_provider.dart';
// import 'package:mega_pro/providers/pro_inventory_provider.dart';
// import 'package:mega_pro/providers/emp_order_provider.dart'; // Add this import
...
//     // Create providers at the dashboard level to prevent recreation
//     return MultiProvider(
//       providers: [
//         ChangeNotifierProvider<ProductionOrdersProvider>(
//           create: (_) => ProductionOrdersProvider(),
...
//   Widget _buildPageForRoute(String routeName) {
//     // Now using providers from parent MultiProvider, no need to recreate them
//     switch (routeName) {
//       case '/dashboard':
//         return DashboardContent(
//           scaffoldKey: _scaffoldKey,
...
// // Dashboard Content (Single definition)
// class DashboardContent extends StatefulWidget {
//   final GlobalKey<ScaffoldState> scaffoldKey;
//   final Map<String, dynamic> userData;
...
//     try {
//       // Add your production metrics fetching logic here
//       if (_isMounted) {
//         setState(() {
...
//   // All the _build methods remain the same as in your original code
//   Widget _buildInventorySummary() {
//     return Container(
//       padding: const EdgeInsets.all(16),
//       decoration: BoxDecoration(
